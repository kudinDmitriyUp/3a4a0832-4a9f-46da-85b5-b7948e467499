...
export const metadata: Metadata = {
  title: "BoatHub - Premium Boats & Yachts for Sale",
  description: "Browse premium boats, yachts, and sailboats. Find your perfect vessel with BoatHub's curated selection and expert guidance.",
  keywords: "boats for sale, yachts, sailboats, cabin cruisers, marine marketplace",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "BoatHub - Find Your Perfect Boat",
    description: "Explore our premium collection of yachts, sailboats, and cruisers",
    siteName: "BoatHub",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "BoatHub - Premium Boats & Yachts",
    description: "Find your perfect boat with BoatHub"
  }
};
